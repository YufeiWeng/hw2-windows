            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        mat4 tran = Transform::translate(values[0], values[1], values[2]);
                        rightmultiply(tran, transfstack);
                    }
                }
                else if (cmd == "scale") {
                    validinput = readvals(s,3,values); 
                    ...
                    if (validinput) {
                        ...
                        glm::mat3 rot = Transform::rotate(float(values[3]), axis);
                        glm::mat4 rotInFour;
                        for (int i = 0; i < 3; i++) {
                            for (int j = 0; j < 3; j++) {
                                rotInFour[i][j] = rot[i][j];
                            }
                        }

                        rotInFour[3][3] = float(1);
                        rightmultiply(rotInFour, transfstack);
                    }
                }
